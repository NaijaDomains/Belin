      ...
      <!--------------------------
        ...
        <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Add Coporate Patient</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="POST" action="#">
                ...
                <div class="form-group">
                    <label>Select Patients HMO</label>
                ...
                <div class="form-group">
                      <label>Enrollee No.</label>
                      <input style="width:30%;" type="text" class="form-control" placeholder="Enter ...">
                </div>
                <div class="form-group">
